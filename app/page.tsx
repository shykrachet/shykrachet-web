      ...
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24 space-y-24">
        ...
        <section id="about" className="space-y-6">
          ...
          <div className="pt-2 flex items-center gap-4 text-sm">
            <button 
              onClick={openModal}
              className="px-5 py-2.5 bg-white text-black font-medium rounded hover:bg-neutral-200 transition-colors"
            >
              Contact Me
            </button>
      ...
      {isModalOpen && (
        <>
          ...
          <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 ${isClosing ? 'modal-overlay-exit' : 'modal-overlay-enter'}`}>
            <div className={`bg-neutral-950 border border-neutral-800 p-6 sm:p-8 rounded-xl max-w-sm w-full relative shadow-2xl ${isClosing ? 'modal-content-exit' : 'modal-content-enter'}`}>
              <button 
                onClick={closeModal}
              ...
              <div className="flex flex-col gap-3">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 hover:border-neutral-600 rounded-lg transition-all"
                >
                ...
                {/* Instagram */}
                <a 
                  href="https://www.instagram.com/shykrachet/" 
                  target="_blank" 
                  rel="noreferrer" 
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 hover:border-neutral-600 rounded-lg transition-all"
                >
                ...
                {/* Github */}
                <a 
                  href="https://github.com/haerinforever" 
                  target="_blank" 
                  rel="noreferrer" 
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 hover:border-neutral-600 rounded-lg transition-all"
                >
                ...
                <button 
                  ...
                  className="w-full flex flex-col items-center justify-center gap-1 px-4 py-3 bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 hover:border-neutral-600 rounded-lg transition-all"
                >
                  ...
                  <span className={`text-xs ${copiedType === "discord" ? "text-green-400" : "text-neutral-500"}`}>
                ...
                >
                  ...
                  <span className={`text-xs ${copiedType === "line" ? "text-green-400" : "text-neutral-500"}`}>
